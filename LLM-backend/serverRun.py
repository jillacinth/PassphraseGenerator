...
#How many 10 question cycles with filtering to run
iterations = 20
...
for i in range(iterations):
    print(f"Starting iteration {i + 1}/10")
    # Initial prompt to generate 10 questions (no system prompt as recommended)
    initial_prompt = """Create a list of ten personal questions with one word or number responses that would be hard for someone to find about you online or for a friend or family member to guess. The answers to these questions should not change over time. There must be more than 100 possible responses to the question. The questions should be widely applicable to most people. Most people should not have the same answer to any of the questions. Do not ask for highly sensitive information. The questions should be limited to common knowledge. Only output the ten questions labeled 1-10 with no other text output."""
    ...
    - There are over 100 possible answers.
    ...
    print(f"Iteration {i + 1}/{iterations + 1} completed.")
